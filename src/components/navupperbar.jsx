...
function UpperBarButton({ label, to }) {
    return (
        <Link className="h-full flex justify-center items-center mx-1 px-2" to={to}>
            <span className="whitespace-nowrap h-7/12 bg-cyan-950 rounded-xl mx-1 border-2 border-cyan-500 px-1.5 text-cyan-600">
                {label}
            </span>
        </Link>
    )
