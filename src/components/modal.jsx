        ...
        <div className="fixed top-16 w-screen h-[calc(100vh-4rem)] overflow-auto flex justify-around items-center mb-8" id="modal_bg">
            ...
            <div  className="fixed z-50 flex flex-col items-center justify-center" id="modal_div">
                <div className="relative flex flex-row items-center justify-center max-w-5xl pointer-events-auto">
                    ...
                    <a  className="fixed z-30 rounded-full bg-[#000000f0] opacity-35 w-12 h-12 left-2 sm:left-2/12 flex justify-center  pl-2 items-center"><i className="arrow select-none w-6 h-6 rotate-135"></i></a>
                    ...
                    <a  className="fixed z-30 rounded-full bg-[#000000f0] opacity-35 w-12 h-12 right-2 sm:right-2/12 flex justify-center  pr-2 items-center"><i className="arrow select-none w-6 h-6 -rotate-45"></i></a>
                </div> 
